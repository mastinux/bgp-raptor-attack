...
class Node(object):
    ...
    def __init__(self, parent=None, **kwargs):
        # mastinux
        #print (kwargs)
        # in kwargs non trovi l'indirizzo ip
        self._parent = parent
        #print ("parent", parent)
        # parent e' un Node
...
class LocalNodeBuilder(NodeBuilder):
    ...
    def _createTorrcFile(self, checkOnly=False):
        ...
        #print(os.environ['MASTINUX_CONFIG'])
        if os.environ['MASTINUX_CONFIG'] == '1':
            # 000authority - 5000
            # 001guard - 5001
            # 002exit - 5002
            # 003client - 5003
        ...
        # mastinux
        # qui formatta il template in base a self_env
        #print ("entering format() for", fn_out)
        ...
        with open(fn_out, 'w') as f:
            ...
            # mastinux
            #print ("--------------------------------------------------------------------------------")
            #print ("++++++++++", self._getTorrcFname(), "content ++++++++++")
...
class TorEnviron(chutney.Templating.Environ):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # mastinux
        # kwargs sono i valori impostati nel file in networks/
    ...
    def _get_owning_controller_process(self, my):
        # mastinux
        #print("_get_owning_controller_process ----------------------------------")
    ...
    def _get_server_dns_resolv_conf(self, my):
        # mastinux
        #print("_get_server_dns_resolv_conf -------------------------------------")
...
class Network(object):
    ...
    def configure(self):
        ...
        for b in builders:
            ...
            b.preConfig(network)
            altauthlines.append(b._getAltAuthLines(self._dfltEnv['hasbridgeauth']))
...
def runConfigFile(verb, data):
    ...
    #print (verb)
    #print ("\ndata -------------------------------------------------------------------------")
    # contenuto del file in networks/
    #print (data)
    #print ("_GLOBALS -----------------------------------------------------------------------")
    #for x in _GLOBALS:
    #    print (x, _GLOBALS[x])
    ...
    # esegue data usando i valori presenti in _GLOBALS

    #print ("entering exec __________________________________________________________________")
    exec(data, _GLOBALS)
    network = _GLOBALS['_THE_NETWORK']
    #print ("exiting exec ___________________________________________________________________")
